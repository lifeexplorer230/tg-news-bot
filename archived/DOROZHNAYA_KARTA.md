...
| 2025-10-15 04:00 | Sprint 4 | U1-U5 | ✅ | Универсализация завершена: удалены hardcoded категории, переименованы классы/переменные, backwards compatibility, универсальная терминология. PR #1 merged в main (7 коммитов, 103/103 tests, 90.61% coverage) |
| 2025-10-15 08:30 | Security | CRITICAL RCE fix | ✅ | Исправлена критическая уязвимость pickle deserialization (CVSS 9.8): заменён pickle.dumps/loads на numpy.save/load с allow_pickle=False. Создан migration script, SECURITY.md. PR #2 merged в main (commit 9160f95, 103/103 tests, 90.74% coverage database/db.py) |
| | | | | |
