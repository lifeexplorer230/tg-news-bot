...
| Дата | Задача | Статус | Комментарий |
|------|--------|--------|-------------|
| 2025-10-15 | Этап 1 | ⏳ | Подготовка: feature branch создан, UNIVERSALIZATION_PLAN.md (480 строк), DOROZHNAYA_KARTA.md обновлена |
| | U1 | ⏳ | Удалить hardcoded категории (wildberries, ozon, general) из кода |
| | U2 | ⏳ | Переименовать классы: MarketplaceProcessor → NewsProcessor, Marketplace → Category |
| | U3 | ⏳ | Переименовать переменные и методы для универсальности |
| | U4 | ⏳ | Обновить конфиг с backwards compatibility (categories + marketplaces) |
| | U5 | ⏳ | Обновить документацию, docstrings, логирование |
...
- **Версия:** 2.2.0-dev
- **Последний коммит:** b1587de (Sprint 3 completed, все изменения запушены в git)
- **Текущий этап:** ⏳ Спринт 4 - Универсализация (0/5 tasks)
- **Текущая ветка:** feature/universalize-codebase
- **Следующая цель:** U1 - Удалить hardcoded категории
- **Блокеры:** Нет
